 ...
 * flownetwork.js - the Flownetwork algorithm visualization library
 *
 * Copyright 2012-2014 Mike Rosulek & the Flownetwork project team
 * http://rosulek.github.io/flownetwork
 *
 * Licenced under MIT
  ...
  this.Flownetwork = {
    ...
    arrayToNum: function(array) {
      ...
      if (!((array != null) && array.constructor.name === 'Array')) {
        console.log("Flownetwork.arrayToNum got non-array input", array);
        return 0;
      }
    ...
    numToArray: function(num) {
      ...
      if (!((num != null) && num.constructor.name === 'Number')) {
        console.log("Flownetwork.numToArray got non-num input", num);
        return [0];
      }
      if (num < 10) {
        return [num];
    ...
    formatObject: function(object, attributes, prevObj) {
      ...
      rows = (function() {
        ...
        for (_i = 0, _len = attributes.length; _i < _len; _i++) {
          ...
          str = Flownetwork.rawToTxt(object[attribute]);
          if ((prevObj != null) && str !== Flownetwork.rawToTxt(prevObj[attribute])) {
            addClass = "class='changed'";
          } else {
            addClass = "";
          }
    ...
    editableValue: function($elem, valFunc, returnFunc) {
      ...
      oldVal = valFunc($elem);
      $editor = $("<input class='inline-input'>").hide().val(oldVal).on("keydown.flownetwork-graph", function(event) {
        var _ref;
        ...
        doneEditing();
        return false;
      }).on("blur.flownetwork-graph something-was-selected", function(event) {
        doneEditing();
        return true;
      });
      $elem.html($editor);
    ...
    "export": function(obj) {
      ...
      root.Flownetwork || (root.Flownetwork = {});
      return this.mixin(root.Flownetwork, obj);
    },
...
(function() {
  ...
  BinaryTree = (function() {
    ...
    BinaryTree["interface"].asGraph = {
      description: "returns an equivalent `Flownetwork.DataStructure.Graph`"
    };

    BinaryTree.prototype.asGraph = function() {
      var g,
        _this = this;
      g = new Flownetwork.DataStructure.Graph();
...
(function() {
  ...
  Graph = (function() {
    ...
    function Graph(args) {
      ...
      this.edges = {};
      this.vertices = {};
      _ref2 = Flownetwork.arrayify(args.vertices);
      ...
      _ref3 = Flownetwork.arrayify(args.edges);
    ...
    Graph.prototype.clone = function() {
      var r;
      r = new Flownetwork.DataStructure.Graph({
      ...
      r.recentlyCollapsed = Flownetwork.clone(this.recentlyCollapsed);
      return r;
    };
    ...
    Graph.prototype.toString = function() {
      ...
      s = "defaultGraph: new Flownetwork.DataStructure.Graph({\n    directed: " + this.directed + ",\n    prefix: \"" + this.prefix + "\",\n    vertices: [\n";
...
(function() {
  ...
  Queue = (function() {
    ...
    Queue.prototype.clone = function() {
      return new Flownetwork.DataStructure.Queue({
        initialArray: Flownetwork.clone(this.guts),
    ...
    Queue.prototype.toString = function() {
      ...
      if (this.isEmpty()) {
        ...
        return "[" + (((function() {
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            elem = _ref[_i];
            _results.push(Flownetwork.rawToTxt(elem));
          }
          return _results;
        }).call(this)).join(", ")) + "]";
      }
...
(function() {
  ...
  Visualizer = (function() {
    ...
    Visualizer.prototype.setWatchVar = function(varName) {
      return Flownetwork.insertSet(varName, this.watchVars);
    };
    ...
    Visualizer.prototype.setBreakpoint = function(b, proc) {
      ...
      return Flownetwork.insertSet(b, this.breakpoints[proc]);
    };
    ...
    Visualizer.prototype.cloneScopeToObj = function(obj, procName, scope, bare, shallow) {
      ...
      for (k in scope) {
        ...
        cloned = shallow ? v : Flownetwork.clone(v);
    ...
    Visualizer.prototype.watchVarsChanged = function() {
      ...
      ret = (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          right = fakeFrame[v];
          if (Flownetwork.stringify(left) === Flownetwork.stringify(right)) {
            continue;
          }
          _results.push(v);
        }
    ...
    Visualizer.prototype["export"] = function() {
      ...
      window.history.replaceState({}, "", window.location.origin + window.location.pathname + "#" + Flownetwork.encode(save));
      return "ok";
    };
    ...
    Visualizer.prototype["import"] = function() {
      ...
      try {
        return Flownetwork.decode(s.substr(1));
      } catch (error) {
        return {};
      }
    };
...
(function() {
  ...
  Array = (function() {
    ...
    Array.dependencies = ["Flownetwork.Widget.ArrayGuts"];
    ...
    function Array(options) {
      ...
      this.$container = Flownetwork.jqueryify(options.container);
      options.container = $("<table>", {
        "class": "array"
      });
      this.$container.append(options.container);
      this.guts = new Flownetwork.Widget.ArrayGuts(options);
    }
  ...
  ArrayGuts = (function() {
    ...
    function ArrayGuts(args) {
      ...
      if ((_ref = this.cellFormat) == null) {
        this.cellFormat = Flownetwork.rawToTxt;
      }
      if ((_ref1 = this.cellParse) == null) {
        this.cellParse = Flownetwork.txtToRaw;
      }
      this.$editBox = null;
      this.editIndex = null;
      this.lastInput = this.defaultInput;
      this.firstIndex = this.ignoreIndexZero ? 1 : 0;
      this.showChanges = Flownetwork.arrayify((_ref2 = this.showChanges) != null ? _ref2 : "next");
    ...
    ArrayGuts.prototype.render = function(frame, type) {
      ...
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        ...
        if (Flownetwork.isNumber(index) && (this.firstIndex <= index && index < newArray.length)) {
    ...
    ArrayGuts.prototype.virtualIndex = function(frame, indexStr) {
      ...
      for (_i = 0, _len = tokens.length; _i < _len; _i++) {
        t = tokens[_i];
        if (prevOp != null) {
          thisTerm = Flownetwork.isNumber(t) ? parseInt(t) : frame[t];
          if (thisTerm == null) {
            return null;
          }
          switch (prevOp) {
...
(function() {
  ...
  BinaryTree = (function() {
    ...
    function BinaryTree(args) {
      ...
      this.theTree = (_ref = this.defaultTree) != null ? _ref : new Flownetwork.DataStructure.BinaryTree();
      this.graphDisplay = new Flownetwork.Widget.GraphDisplay({
    ...
    BinaryTree.prototype.setContainerEditBindings = function() {
      var _this = this;
      return this.graphDisplay.$outer.on("click.flownetwork-graph", function(e) {
        var $target;
        $target = $(e.target);
    ...
    BinaryTree.prototype.openDrawer = function() {
      ...
      if (node.right != null) {
        buttons.push($("<button>", {
          text: "rotate left"
        }).on("click.flownetwork-graph", function(e) {
          var rightChild;
    ...
    BinaryTree.prototype.editValue = function($node) {
      ...
      returnFunc = function(newVal) {
        var val;
        val = Flownetwork.txtToRaw(newVal);
        if (newVal != null) {
          _this.theTree.changeVal(nodeId, val);
        }
        return Flownetwork.rawToTxt(val);
      };
      return Flownetwork.editableValue($contents, valFunc, returnFunc);
    };
...
(function() {
  ...
  CallStack = (function() {
    ...
    function CallStack(args) {
      ...
      this.$container = Flownetwork.jqueryify(this.container);
      this.$inner = $("<div>", {
        "class": "callstack"
        ...
        for (k in _ref) {
          ...
          if (!/^_/.test(k)) {
            if (__indexOf.call(this.ignoreArgumentValues, k) >= 0) {
              ...
              _results.push("" + k + "=" + (Flownetwork.rawToTxt(v)));
            }
          }
        }
        return _results;
    ...
    CallStack.prototype.retStr = function(scope) {
      ...
      if (scope.procName in this.formatReturnValue) {
        ...
        ret = Flownetwork.arrayify(scope.returnValue);
        s = ((function() {
          var _i, _len, _results;
          _results = [];
          for (_i = 0, _len = ret.length; _i < _len; _i++) {
            r = ret[_i];
            _results.push(Flownetwork.rawToTxt(r));
          }
          return _results;
        })()).join(",");
      }
...
(function() {
  ...
  ControlFrameLabel = (function() {
    ...
    function ControlFrameLabel(_arg) {
      ...
      this.$frameLabel = Flownetwork.jqueryify(container);
  ...
  ControlButtons = (function() {
    ...
    function ControlButtons(_arg) {
      ...
      this.$container = Flownetwork.jqueryify(container);
    ...
    ControlButtons.prototype.setupInput = function() {
      ...
      for (varName in _ref) {
        ...
        $val = $("<span>", {
          "class": "val",
          html: defaultValue != null ? Flownetwork.rawToTxt(defaultValue) : "???"
        });
      ...
      for (varName in _ref) {
        ...
        _results.push((function(varName, $div, ths) {
          ...
          return $div.on("click", function() {
            return Flownetwork.editableValue($div.children("span.val"), (function(e) {
              return Flownetwork.txtToRaw(e.text());
            }), function(newval) {
              var v;
              if (newval != null) {
                v = Flownetwork.txtToRaw(newval);
                ths.inputVars[varName] = v;
                ths.visualizer.setVariable(varName, v);
              }
              return Flownetwork.rawToTxt(ths.inputVars[varName]);
            });
          });
        })(varName, $div, this));
      }
  ...
  ControlSlider = (function() {
    ...
    function ControlSlider(_arg) {
      ...
      this.$slider = Flownetwork.jqueryify(container);
  ...
  GraphDisplay = (function() {
    ...
    function GraphDisplay(args) {
      ...
      Flownetwork.handleArguments({
        widgetObject: this,
        givenArgs: args,
        specObj: Flownetwork.Widget.GraphDisplay.spec
      });
      this.$outer = Flownetwork.jqueryify(this.container);
      ...
      for (type in _ref) {
        ...
        if (style.constructor.name === "Function") {
          target.text(function(d) {
            return Flownetwork.rawToTxt(style(d));
          });
          ...
          target.text(function(d) {
            ...
            for (_i = 0, _len = style.length; _i < _len; _i++) {
              ...
              if (((_ref1 = _this.currentFrame[v]) != null ? _ref1.id : void 0) === d.id) {
                res.push(Flownetwork.resolveSubscript(Flownetwork.removeNamespace(v)));
              }
            }
            return res.join(",");
          });
          ...
          target.text(function(d) {
            return Flownetwork.rawToTxt(style[_this.mode](d));
          });
        } else {
          target.text("");
        }
    ...
    GraphDisplay.prototype.edgeLabelVal = function(edge) {
      ...
      if (this.edgeLabel[this.mode].constructor.name === 'Function') {
        ...
        return val = Flownetwork.rawToTxt((_ref = edge[attr]) != null ? _ref : "");
      } else {
      ...
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        ...
        _results.push(edges.each(function(e) {
          ...
          if ((res != null ? res.length : void 0) === 2) {
            ...
            Flownetwork.insertSet(attr, styles);
...
(function() {
  ...
  Graph = (function(_super) {
    ...
    Graph.dependencies = ["Flownetwork.Widget.GraphDisplay"];
    ...
    Graph.spec = {
      ...
      defaultGraph: {
        type: "Graph",
        defaultValue: void 0,
        description: "the initial graph, as a Flownetwork.DataStructure.Graph"
      },
      inputVars: {
        type: "Object",
        defaultValue: {},
    ...
    function Graph(args) {
      ...
      this.showChanges = Flownetwork.arrayify(this.showChanges);
      for (argName in Flownetwork.Widget.Graph.spec) {
        delete args[argName];
      }
      if (this.editable) {
        this.theGraph = (_ref = this.defaultGraph) != null ? _ref : new Flownetwork.DataStructure.Graph();
      ...
      switch (event) {
        ...
        case "externalInput":
          ...
          if (((_ref = inp[this.varName]) != null ? _ref.type : void 0) === "Graph") {
            newg = new Flownetwork.DataStructure.Graph();
    ...
    Graph.prototype.updateVariables = function() {
      ...
      graph = Flownetwork.clone((_ref = this.theGraph) != null ? _ref : this.defaultGraph);
    ...
    Graph.prototype.setEditBindings = function() {
      var _this = this;
      this.inner.selectAll("g.vertex").classed("editable-vertex", true).on("click.flownetwork-graph", function(d) {
      ...
      this.inner.selectAll("path.edge").on("mouseenter.flownetwork-graph", function(d) {
        return d3.select(this).classed("selectme", true);
      }).on("mouseout.flownetwork-graph", function(d) {
        return d3.select(this).classed("selectme", null);
      }).on("click.flownetwork-graph", function(d) {
        _this.selectEdgeBySelector(d3.select(d3.event.target));
        return _this._notNewVertexClick = true;
      });
      this.$outer.off("click.flownetwork-graph");
      return this.$outer.on("click.flownetwork-graph", function(e) {
    ...
    Graph.prototype.unsetEditBindings = function() {
      this.$outer.off("click.flownetwork-graph");
      this.inner.selectAll("g.vertex").on("click.flownetwork-graph", null).classed("editable-vertex", null);
      return this.inner.selectAll("path.edge").on("mouseenter.flownetwork-graph", null).on("mouseout.flownetwork-graph", null).classed("selectme", null);
    };
    ...
    Graph.prototype.selectVertexBySelector = function(sel) {
      ...
      this.inner.selectAll("g.vertex").on("mouseover.flownetwork-graph", function(v) {
        return _this.potentialEdgeTo(v.id);
      }).on("mouseleave.flownetwork-graph", function(v) {
    ...
    Graph.prototype.unsetPotentialEdgeBindings = function() {
      this.removePotentialEdge();
      return this.inner.selectAll("g.vertex").on("mouseover.flownetwork-graph", null).on("mouseleave.flownetwork-graph", null);
    };
    ...
    Graph.prototype.openDrawer = function() {
      ...
      if (type === 'vertex') {
        ...
        _fn = function(v, vtx, buttons, ths, inputVars, theGraph) {
          var $b, vName,
            _this = this;
          vName = Flownetwork.resolveSubscript(v);
          $b = $("<button>", {
            text: vName,
            title: "Set " + vName + "=" + vtx.name
          });
          $b.on("click.flownetwork-graph", function(e) {
            inputVars[v] = vtx;
            return ths.redraw();
          });
        ...
        if (this.editableEdgeAttrs) {
          ...
          _fn2 = function(edge, attrName, buttons, ths, inputVars, theGraph) {
            ...
            $label = $("<div>", {
              ...
              return Flownetwork.editableValue($val, (function(e) {
                return e.text();
              }), update);
            });
  ...
  })(this.Flownetwork.Widget.GraphDisplay);
...
(function() {
  ...
  Matrix = (function() {
    ...
    Matrix.dependencies = ["Flownetwork.Widget.ArrayGuts"];
    ...
    Matrix.prototype.virtualIndex = function(frame, indexStr) {
      ...
      for (_i = 0, _len = tokens.length; _i < _len; _i++) {
        t = tokens[_i];
        if (prevOp != null) {
          thisTerm = Flownetwork.isNumber(t) ? parseInt(t) : parseInt(frame[t]);
          if (thisTerm == null) {
            return null;
          }
          switch (prevOp) {
    ...
    Matrix.prototype.comparator = function(str, a, b) {
      var res;
      if (Flownetwork.isNumber(a) && Flownetwork.isNumber(b)) {
...
(function() {
  ...
  ParallelArrays = (function() {
    ...
    ParallelArrays.dependencies = ["Flownetwork.Widget.ArrayGuts"];
    ...
    function ParallelArrays(sharedOptions) {
      ...
      this.$container = Flownetwork.jqueryify(sharedOptions.container);
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        combinedOptions = Flownetwork.clone(sharedOptions);
        ...
        this.guts.push(new Flownetwork.Widget.ArrayGuts(combinedOptions));
      }
    }
...
(function() {
  ...
  Pseudocode = (function() {
    ...
    function Pseudocode(args) {
      ...
      this.mostRecent = 0;
      nLines = this.formatContainer(Flownetwork.jqueryify(this.container));
    ...
    Pseudocode.prototype.addClassToLine = function(n, klass) {
      if (Flownetwork.isNumber(n)) {
        return this.$tbl.find("tr[flownetwork-linenumber=" + n + "]").addClass(klass);
      }
    };
    ...
    Pseudocode.prototype.enableBreakpointSelection = function() {
      ...
      gutter.on("mousedown", function(event) {
        var n;
        n = $(event.target).closest("tr").attr("flownetwork-linenumber");
        _this.toggleBreakpoint(n);
        _this.mouseDownMode = _this.getBreakpointStatus(n);
        return false;
      });
      $(window).on("mouseup.flownetwork", function() {
    ...
    Pseudocode.prototype.disableBreakpointSelection = function() {
      ...
      $(window).off("mouseup.flownetwork");
    ...
    Pseudocode.prototype.getLine = function(n) {
      return this.$tbl.find("tr[flownetwork-linenumber=" + n + "]");
    };
    ...
    Pseudocode.prototype.formatContainer = function($container) {
      ...
      for (_i = 0, _len = html_lines.length; _i < _len; _i++) {
        ...
        this.$tbl.append($("<tr>", {
          ...
          "flownetwork-linenumber": lineNumberStr
        }).append($("<td>", {
...
(function() {
  ...
  Queue = (function() {
    ...
    Queue.dependencies = ["Flownetwork.Widget.ArrayGuts"];
    ...
    function Queue(args) {
      ...
      this.arrayWidget = new Flownetwork.Widget.Array(args);
    }
    ...
    Queue.prototype.event = function() {
      ...
      switch (event) {
        ...
        case "render":
          frame = options[0], type = options[1];
          newFrame = Flownetwork.clone(frame);
  ...
  UserQuiz = (function() {
    ...
    function UserQuiz(args) {
      ...
      if ((_ref = this.title) == null) {
        this.title = Flownetwork.funcify("Self-test question");
      }
      this.question = Flownetwork.funcify(this.question);
      this.answer = Flownetwork.funcify(this.answer);
      this.$dialog = $("<div>", {
        "class": "userquiz"
      });
      this.$dialog.hide();
  ...
  VarDisplay = (function() {
    ...
    VarDisplay.prototype.showVars = function(frame, type) {
      ...
      if (!(frame[this.varName] != null)) {
        ...
        if (__indexOf.call(this.showChanges, type) >= 0) {
          newstr = Flownetwork.formatObject(frame[this.varName], this.attributes, this.oldval);
        } else {
          newstr = Flownetwork.formatObject(frame[this.varName], this.attributes);
        }
        this.dontShowChange = true;
      } else {
        newstr = Flownetwork.rawToTxt(frame[this.varName]);
      }
...
(function() {
  ...
  VarName = (function() {
    ...
    function VarName(args) {
      ...
      this.displayName = Flownetwork.resolveSubscript(this.displayName);
      this.$container = Flownetwork.jqueryify(this.container);
